const allQuotes = [
  ...
  [ "You talk too damn much and too damn much of it is about you.", "The Long Goodbye" ],
  [ "The tragedy of life, Howard, is not that the beautiful die young, but that they grow old and mean.", "The Long Goodbye"],
  ...
  [ "As honest as you can expect a man to be in a world where its going out of style.", "The Big Sleep" ],
  ...
  [ "Cleverness, like perhaps strawberries, is a perishable commodity.", "Letter to Helga Greene" ],
  [ "A legal system which can't convict Al Capone of anything but income tax fraud is apt to make the police rather cynical.", "Letter to James Sandoe" ],
  [ "The character that lasts is an ordinary guy with some extraordinary qualities", "Letter to Erle Stanley Gardner" ],
  [ "When in doubt have a man come through the door with a gun in his hand.", "The Simple Art of Murder"],
  [ "Time passed again. I don't know how long. I had no watch. They don't make that kind of time in watches anyway.", "Farewell My Lovely" ]
];
